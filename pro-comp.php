	...
	<thead>
		...
		if (mysqli_num_rows($data)>0) {
			...
			while ($tampil=mysqli_fetch_array($data)){
				...
				<td><?php echo "<img src='foto/$tampil[foto]' width='90' height='90' />" ?></td>
				<td><button class="into" onclick="document.location='detail-pro.php?id_pengaduan=<?=$tampil['id_pengaduan']?>'">Select</button></td>
				</tr>
			<?php $no++;}}?>
        </tbody>
