...
<form action="updt-finish.php" method="post" enctype="multipart/form-data">
...
<textarea class="newinputt" rows="5" cols="50" type="textarea" name="tanggapan"></textarea><br>
<br>
<br>
<button class="into" name="status" value="selesai"> Finish</button>
<br>
<br>
</form>
